...
;========================================================================================
M92 X1600 Y1600 Z800 E405		   	   	           ; (1:3 = 385-395) je mehr steps ums so länger extrudiert er...
;M92 X1604.6 Y1604.33 Z800 E380		   	   	           ; (1:3 = 385-395) je mehr steps ums so länger extrudiert er...
;========================================================================================
...
;========================================================================================
;========================================================================================
G31 P500 X40 Y8 Z1.475  ;Z probe trigger value ****wert grösser=näher*****, wert kleiner, Düse hebt hab, von 2.115)
;========================================================================================
;========================================================================================
...
M570 H1 P15										   ; set heater timeout to 10s (default5)

M307 H0 R0.192 K0.154:0.000 D0.70 E1.00 S1.00 B0
M307 H1 R2.432 K0.236:0.000 D10.59 E1.35 S1.00 B0 V23.9
